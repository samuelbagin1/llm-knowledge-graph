...
The merged schema from ODD is sent to a schema refinemnt using Gemini 2.5 Pro call together with any existing ontology already stored in graph: $S^{\ast}=\Phi(S_{\text{ODD}},\,S_0)$. The refinement step has a clear linguistic role: it resolves duplicates caused by diacritics or minor spelling variants (for example Dan vs Daň), and semantically simillar types (for example Doklad, DanovyDoklad and HodnovernyDoklad into Doklad). It enforces upper-snake-case for relation types and it refuses to merge semantically distinct categories such as \textit{document} and \textit{person}. A merge log is kept that maps every canonical type back to the raw variants it absorbed, which is useful both for debugging and for auditing. A special type \textit{Paragraph} is always added to the node list, because every legal fact in the graph should be traceableback to the paragraph that states it.
...
\begin{minipage}[t]{0.48\textwidth}
  ...
  \captionof{figure}{{Knowledge graph structure: document, chunk, entity and relationships. Image taken and edited to our solution from Neo4j}~\cite{neo4jSchema}}
...
\bibitem{1}
Badhan Chandra Das, M. Hadi Amini, Yanzhao Wu, "Security and Privacy in Large Language Models: A Survey," 2024.
...
\bibitem{3}
Bayron Jossue Serrano Mena, "KnoBuilder: An LLM-Agent for Autonomous and Personalized Knowledge Graph Construction from Unstructured Text", 2025. \url{https://openreview.net/pdf?id=teewCPCv2m}

\bibitem{4}
Huang et al., "Can LLMs be Good Graph Judge for Knowledge Graph Construction?," 2025. \url{https://aclanthology.org/2025.emnlp-main.554.pdf}

\bibitem{7}
Shen et al., "Reasoning with Trees: MCTS for Multi-Hop Question Answering," 2025. \url{https://aclanthology.org/2025.coling-main.211.pdf}

\bibitem{11}
Chent et al., "GMeLLo: LLM-Based Multi-Hop Question Answering with Knowledge Graph Integration in Evolving Environments," 2025. \url{https://arxiv.org/html/2408.15903}

\bibitem{12}
Guo et al., "LightRAG: Simple and Fast Retrieval-Augmented Generation," 2024. \url{https://arxiv.org/pdf/2410.05779}

\bibitem{13}
Cao et al., "LEGO-GraphRAG: Modularizing Graph-based Retrieval-Augmented Generation for Design Space Exploration," 2025. \url{https://arxiv.org/pdf/2411.05844}
...
\bibitem{b3} Neo4j, Inc., ``Neo4j graph database,''. https://neo4j.com/
\bibitem{b4} LangChain, Inc., ``LangChain documentation,'' https://docs.langchain.com/
\bibitem{b7} Slov-Lex, ``Legal and information portal,'' Ministry of Justice of the Slovak Republic. https://www.slov-lex.sk/
...
\bibitem{neo4jSchema} Neo4j Lexical Graph With Extracted Entities
