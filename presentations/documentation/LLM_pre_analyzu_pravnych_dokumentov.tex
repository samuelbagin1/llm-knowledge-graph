...
\begin{itemize}
    ...
    \item Anthropic
        \begin{itemize}
            \item \textbf{sonnet-3.5}: Model používaný na tvorenie Cypher Queries pre dopytovanie na grafovú databázu. Silné znalosti na tvorenie kódu a SQL, rýchly, efektívny na riešenie problémov.
...
knižnice z \texttt{requirements.txt}. Do vytvoreného súboru \textbf{.env}, používateľ zadá svoje API
...
otvorenej doméne, aj tu je každý chunk spracovaný paralelne.
...
\begin{figure}[h]
  ...
  \begin{subfigure}[c]{0.45\textwidth}
    ...
    \caption{Grafová databáza s dátami}
...
Používateľ zadá otázku v prirodzenom jazyku, prostredníctvom metódy \textbf{query}.
\begin{lstlisting}
...
\begin{itemize} 
    ...
    že výsledná odpoveď bude podložená reálnymi vzťahmi.
\end{itemize}
...
\url{https://arxiv.org/pdf/2003.02320}\\
\url{https://arxiv.org/pdf/1805.02262}\\
\url{https://blog.langchain.com/exploring-prompt-optimization/}\\
\url{https://lexpredict-lexnlp.readthedocs.io/en/latest/modules/extract/extract.html#pattern-based-extraction-methods}\\
...
\url{https://medium.com/@yu-joshua/a-unified-framework-for-ai-native-knowledge-graphs-8bd823385fe6}\\
\url{https://pub.towardsai.net/why-llms-fail-at-knowledge-graph-extraction-and-what-works-instead-dcb029f35f5b}\\
\url{https://pub.towardsai.net/building-a-self-updating-knowledge-graph-from-meeting-notes-with-llm-extraction-and-neo4j-b02d3d62a251}\\
\url{https://medium.com/@visrow/semantic-graphrag-implementation-guide-build-real-world-ai-knowledge-systems-with-neo4j-qdrant-9d272d2f99c4}\\
\url{https://medium.com/@shereshevsky/building-knowledge-graphs-from-homers-iliad-open-domain-vs-schema-guided-extraction-ef0bf3874a33}\\
\url{https://arxiv.org/html/2509.04696v1}\\
\url{https://arxiv.org/pdf/2410.21306}\\
\url{https://medium.com/@khrizellelascano/analysis-of-legal-texts-using-nlp-774913be9a03}\\
\url{https://www.mdpi.com/2079-9292/13/3/648}\\
\url{https://arxiv.org/html/2508.06368v1}\\
\url{https://ai.gov.uk/blogs/understanding-legislative-networks-building-a-knowledge-graph-of-uk-legislation/}\\
\url{https://medium.com/neo4j/from-legal-documents-to-knowledge-graphs-ccd9cb062320}\\
\url{https://znalosti.gov.sk}\\
\url{https://arxiv.org/pdf/2512.20136}\\
\url{https://arxiv.org/pdf/2404.19234}\\
\url{https://medium.com/neo4j/knowledge-graphs-llms-multi-hop-question-answering-322113f53f51}\\
\endgroup
}
