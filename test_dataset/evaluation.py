...
def main() -> None:
    ...
    predictions_path: Optional[Path] = Path(__file__).resolve().parent / "linearized_eval_results_few-shot_gpt-5.5-high"
    output_dir: Path = Path(__file__).resolve().parent / "linearized_eval_results_few-shot_gpt-5.5-high"
